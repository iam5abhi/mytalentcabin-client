...
export default function EducationDeleteModal({setOpen,open,id,ProfileSubmit}) {
  ...
  const ExperienceDelete=async()=>{
    try {
      const res = await authFetch.patch('/student/delete-exp',{_id:id});
      setOpen(false)
      ProfileSubmit()
      ToastSucess("Delete Experience Successfully");
                  ...
                  <div className="  bg-white border col-span-2">
                    <div className=" border-b border-gray-200 rounded">
                      ...
                      <p className="  text-lg  font-semibold text-gray-600">
                          Are u sure delete this Experience?
                        </p>
                      </div>                   
