...
export default function CompanyEditModal({setOpen,open,id,GetHrsData}) {
  ...
  const EditSubmitHandler = async ()=>{
      try {
        const resp = await authFetch.patch(`/admin/company/${id}`,{name:fromData.name,email: fromData.email,
