                       ...
                       <form onSubmit={formik.handleSubmit}>
                        <div className="px-4 mt-8">
                            ...
                            <li className="w-full rounded-t-lg  ">
                                ...
                                <input type="text" id="default-input" name='title' onChange={formik.handleChange} placeholder="Enter Category" className="bg-gray-50 border border-gray-300 text-gray-900 text-lg font-normal rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2" />
                                </div>
                            </li>
                            <br />  
                            </ul>
                            <div className=" w-full text-center mt-2 mb-4">
                            <button type="submit" disabled={disableBUtton} className="text-white text-end bg-orange-600 hover:bg-orange-400
